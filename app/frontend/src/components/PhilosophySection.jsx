  ...
  return (
    <section id="philosophy" className="philosophy">
      <div className="wrap philosophy-wrap">
        ...
        <p className="philosophy-body">
          Your child learns from passionate teachers who spark curiosity, support real academic growth, and keep them motivated to perform well at school — turning studies into something they enjoy, not endure.
        </p>
      </div>
    </section>
  );
