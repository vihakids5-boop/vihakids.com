    ...
    <section id="contact">
      <div className="wrap">
        <div className="cta-band">
          ...
          <p>Message us with your child's grade, school, and the subject you'd like help with — Kannada, Hindi or Math — and we'll suggest the right starting point.</p>
          <div className="hero-ctas">
            <a
              className="btn btn-primary"
              href="https://wa.me/919972577828?text=Hi%2C%20I%27d%20like%20to%20know%20more%20about%20Kannada%2C%20Hindi%2C%20Math%20and%20Science%20tuitions"
              target="_blank"
          ...
          <p className="trust-line"><strong>⭐ 5.0</strong> rated by parents in Bengaluru · No payment, no commitment for the free demo</p>
