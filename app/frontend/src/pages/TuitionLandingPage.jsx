...
const RELATED_BLOG_POSTS = {
  ...
  'english-online-tuition': [{ to: '/blog-english-grammar-basics.html', label: 'English Grammar Basics for Kids: Parts of Speech & Present Tense' }, { to: '/english-alphabet-tracing-worksheet', label: 'Free English A to Z tracing worksheet' }],
