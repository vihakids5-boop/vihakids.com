    ...
    <main id="top">
      <section className="hero">
        <div className="wrap hero-grid">
          <div>
            <span className="eyebrow">Online · 1st to 10th Std · Bengaluru</span>
            <h1><span className="kn">Learn with joy</span>No more exam stress</h1>
            <p className="lead">Live online tuitions in Kannada, Hindi, Mathematics and Science for school students — personal attention, patient tutors, and real progress.</p>
            ...
            <p className="trust-line"><strong>⭐ 5.0</strong> rated by parents in Bengaluru · Register takes 30 seconds — no payment required</p>
            <p className="hero-note">One-on-one and small-batch online classes · 1st to 10th Standard</p>
