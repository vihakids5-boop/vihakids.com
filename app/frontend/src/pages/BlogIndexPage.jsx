    ...
    <main id="top">
      <div className="wrap">
        <div className="page-head">
          ...
          <h1>Tips for English, Hindi, Math, Science &amp; Kannada learning</h1>
          <p className="lead">Practical guides for parents across India — helping your child build reading confidence, understand board differences, and get the most out of tuition support.</p>
        </div>
        ...
        <div className="cta-band">
          ...
          <a
            ...
            href={`${WHATSAPP_BASE}${encodeURIComponent("Hi, I'd like to know more about English, Hindi, Math, Science and Kannada tuitions")}`}
            target="_blank"
